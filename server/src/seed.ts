  ...
  const requests = [
    {
      ...
      quantity: 2,
      unit: "pcs",
      reason: "Ошибочный заказ в час пик",
      deductionType: "without_deduction",
      comment: "2 чизбургера курица х2 собрали для ошибочного заказа, после передачи их нельзя продать.",
      ...
      aiGeneratedComment: "2 чизбургера курица х2 собрали для ошибочного заказа, после передачи их нельзя продать.",
    ...
    },
    {
      ...
      quantity: 3,
      unit: "pcs",
      reason: "Остыли и не продались после времени хранения",
      deductionType: "with_deduction",
      deductionEmployeeId: "u-employee-daniyar",
      comment: "3 порции картофеля фри превысили время хранения и остыли при проверке на выдаче.",
      photoUrl: "https://images.unsplash.com/photo-1591189863430-ab87e120f312?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=900",
      aiGeneratedComment: "3 порции картофеля фри превысили время хранения и остыли при проверке на выдаче.",
    ...
    },
    {
      ...
      quantity: 4,
      unit: "bottle",
      reason: "Повреждённые бутылки нашли при передаче смены",
      deductionType: "without_deduction",
      comment: "4 бутылки Coca-cola 0,5 л повредились при передаче смены и сняты с продажи.",
      photoUrl: "https://images.unsplash.com/photo-1503810473512-f64b56827964?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=900",
      aiGeneratedComment: "4 бутылки Coca-cola 0,5 л повредились при передаче смены и сняты с продажи.",
    ...
    },
    {
      ...
      quantity: 1,
      unit: "pcs",
      reason: "Возврат комбо без чёткого фото-подтверждения",
      deductionType: "without_deduction",
      comment: "1 комбо чизбургер говядина вернули, но на фото-подтверждении товар виден нечётко.",
      photoUrl: "https://images.unsplash.com/photo-1503810473512-f64b56827964?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=900",
      status: "rejected",
      reviewedByUserId: "u-reviewer-zarina",
      reviewedAt: new Date(now - 22 * 60 * 60 * 1000),
      rejectionReason: "Фото нечёткое: переснимите так, чтобы повреждение было хорошо видно.",
      costEstimate: 1610,
    ...
    },
    {
      ...
      quantity: 5,
      unit: "pcs",
      reason: "Приготовили сверх спроса в конце дня, ошибка синхронизации",
      deductionType: "with_deduction",
      deductionEmployeeId: "u-employee-aigerim",
      comment: "5 чизбургеров говядина приготовили сверх спроса, к концу дня они не продались.",
      photoUrl: "https://images.unsplash.com/photo-1466637574441-749b8f19452f?crop=entropy&cs=tinysrgb&fit=max&fm=jpg&q=80&w=900",
